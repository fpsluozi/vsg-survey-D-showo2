"""Build the 26 survey pages (13 prompts x base/Gemma4 condition) for the showo2 model.
...
Images: survey_images/showo2_base/<id>.png and survey_images/showo2_gemma/<id>.png.
